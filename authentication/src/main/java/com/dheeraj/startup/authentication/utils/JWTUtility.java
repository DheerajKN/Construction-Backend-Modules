...
public class JWTUtility implements Serializable {
	...
	private String doGenerateToken(Map<String, Object> claims, UUID uuid) {
		return Jwts.builder().setClaims(claims).setSubject(String.valueOf(uuid))
	...
	// validate token
	public void validateToken(String token) throws BeanNotFoundException {
		if (isTokenExpired(token))
			throw new BeanNotFoundException("Token expired", HttpStatus.valueOf(307));
	}
}